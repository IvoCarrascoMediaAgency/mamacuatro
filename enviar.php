...
$destinatario = "nicoleo@disenodepaginaswebquito.com";


// Datos de la cuenta de correo utilizada para enviar v�a SMTP
$smtpHost = "smtp.zoho.com";  // Dominio alternativo brindado en el email de alta 
$smtpUsuario = "nicoleo@disenodepaginaswebquito.com";  // Mi cuenta de correo
$smtpClave = "Zmega$2018";  // Mi contrase�a
